...
export const kRegisteredMaps: Record<string, RegisteredMap> = {
    "de_ancient": {
        displayName: Promise.resolve("Ancient"),
    ...
    "de_anubis": {
        displayName: Promise.resolve("Anubis"),
    ...
    "de_cache": {
        displayName: Promise.resolve("Cache"),
    ...
    "de_dust2": {
        displayName: Promise.resolve("Dust 2"),
    ...
    "de_inferno": {
        displayName: Promise.resolve("Inferno"),
    ...
    "de_mirage": {
        displayName: Promise.resolve("Mirage"),
    ...
    "de_nuke": {
        displayName: Promise.resolve("Nuke"),
    ...
    "de_overpass": {
        displayName: Promise.resolve("Overpass"),
    ...
    "de_train": {
        displayName: Promise.resolve("Train"),
    ...
    "de_vertigo": {
        displayName: Promise.resolve("Vertigo"),
